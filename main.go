...
func main() {
	...
	clearTerminal()
	fmt.Fprintln(conn, `execute install nano; touch; add screen.title=OpenTTY GO; add screen.title=OpenTTY Go; add screen.back.label=Exit; add screen.back=execute exit; add screen.button=Return; add screen.button.cmd=exec unalias xterm & clear & xterm & stop bind; add screen.fields=notes; add screen.notes.type=text; add screen.notes.value=You're accessing this Device via OpenTTY Golang.; install go-term; alias xterm=x11 make go-term; xterm;`)
